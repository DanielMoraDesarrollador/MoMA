...
public class ActivityDetalle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentDetallePagerAdapterObra fragmentDetallePagerAdapterObra = new FragmentDetallePagerAdapterObra(getSupportFragmentManager(), listaDeFragments);
        viewPager.setAdapter(fragmentDetallePagerAdapterObra);
